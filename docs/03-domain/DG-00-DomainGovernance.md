...
|---------|------------|----------------------------------------------|
| 1.0.0   | 2026-07-20 | Initial domain governance document           |
| 1.1.0   | 2026-07-20 | Added architectural governance rules for Business Operations, Business Events and Business History. |
