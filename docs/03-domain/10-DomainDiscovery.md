...
|----------|------------|---------------------------------------------|
| 1.0.0 | 2026-07-20 | Initial Domain Discovery catalog |
| 1.1.0 | 2026-07-20 | Added Tracked Components as a new root business capability and renumbered subsequent discoveries |
| **1.2.0** | **2026-07-20** | Added Maintenance Operations as a core discovered business capability and renumbered subsequent capabilities. |
