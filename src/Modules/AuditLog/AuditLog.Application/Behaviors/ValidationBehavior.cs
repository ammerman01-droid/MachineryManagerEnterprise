...
namespace MachineryManagerEnterprise.AuditLog.Application.Behaviors;
...
/// Identical implementation to the other modules' ValidationBehavior
/// (chat, 2026-09-06 — aligned with Asset.Application's copy).
/// </summary>
