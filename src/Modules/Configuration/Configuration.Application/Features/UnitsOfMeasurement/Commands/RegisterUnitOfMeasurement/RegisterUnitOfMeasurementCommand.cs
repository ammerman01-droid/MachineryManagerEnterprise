...
/// <param name="CategoryId">The identifier of the Unit Category this unit belongs to.</param>
public sealed record RegisterUnitOfMeasurementCommand(Guid HoldingId, string Name, Guid CategoryId)
