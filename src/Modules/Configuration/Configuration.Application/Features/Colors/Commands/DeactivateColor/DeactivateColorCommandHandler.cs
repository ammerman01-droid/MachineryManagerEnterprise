...
/// <summary>Handles <see cref="DeactivateColorCommand"/>.</summary>
public sealed class DeactivateColorCommandHandler : IRequestHandler<DeactivateColorCommand, Result>
{
    private const string RequiredPermission = "Color.Delete";
    ...
    /// <summary>Initializes a new instance of the <see cref="DeactivateColorCommandHandler"/> class.</summary>
    ...
    public DeactivateColorCommandHandler(
    ...
    public async Task<Result> Handle(DeactivateColorCommand request, CancellationToken cancellationToken)
    {
        ...
        var result = color.Deactivate(_dateTimeProvider);
