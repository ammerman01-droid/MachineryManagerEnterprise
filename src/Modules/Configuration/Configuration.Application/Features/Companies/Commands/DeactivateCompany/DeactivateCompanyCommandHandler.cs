...
{
    private const string RequiredPermission = "Company.Delete";
    ...
    /// <summary>Initializes a new instance of the <see cref="DeactivateCompanyCommandHandler"/> class.</summary>
    ...
    public async Task<Result> Handle(DeactivateCompanyCommand request, CancellationToken cancellationToken)
    {
        ...
        var result = company.Deactivate(_dateTimeProvider);
