...
/// <summary>
/// Handles <see cref="ConvertWorkOrderToRepairCommand"/> by loading the
/// aggregate, invoking the domain conversion behavior, and committing
/// the unit of work.
/// </summary>
public sealed class ConvertWorkOrderToRepairCommandHandler
    : IRequestHandler<ConvertWorkOrderToRepairCommand, Result>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="ConvertWorkOrderToRepairCommandHandler"/> class.</summary>
    public ConvertWorkOrderToRepairCommandHandler(
    ...
    /// <summary>Executes the convert-to-repair use case.</summary>
    public async Task<Result> Handle(ConvertWorkOrderToRepairCommand request, CancellationToken cancellationToken)
    {
        ...
        var result = workOrder.ConvertToRepair(_dateTimeProvider);
