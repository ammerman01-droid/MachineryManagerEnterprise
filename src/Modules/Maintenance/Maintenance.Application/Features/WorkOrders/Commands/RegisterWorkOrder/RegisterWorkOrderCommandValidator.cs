...
/// <summary>Validates <see cref="RegisterWorkOrderCommand"/> per ADR-0036.</summary>
public sealed class RegisterWorkOrderCommandValidator : AbstractValidator<RegisterWorkOrderCommand>
{
    /// <summary>Initializes validation rules for the register Work Order command.</summary>
    public RegisterWorkOrderCommandValidator()
    {
