...
namespace MachineryManagerEnterprise.Maintenance.Application.Behaviors;

/// <summary>
/// MediatR pipeline behavior that executes FluentValidation validators
/// before the request handler. Per ADR-0036, validation runs
/// automatically and handlers shall NOT perform ad hoc input validation.
/// </summary>
    ...
    where TRequest : notnull
{
    ...
    /// <summary>Validates the request before delegating to the handler.</summary>
