...
/// <summary>
/// Handles <see cref="ActivateAssetCommand"/> by loading the aggregate,
/// invoking the domain activation behavior, and committing the unit of
/// work.
/// </summary>
public sealed class ActivateAssetCommandHandler
    : IRequestHandler<ActivateAssetCommand, Result>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="ActivateAssetCommandHandler"/> class.</summary>
    public ActivateAssetCommandHandler(
    ...
    /// <summary>Executes the activation use case.</summary>
    public async Task<Result> Handle(ActivateAssetCommand request, CancellationToken cancellationToken)
    {
        ...
        var result = asset.Activate(_dateTimeProvider);
